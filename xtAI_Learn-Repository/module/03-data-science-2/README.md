...
**Nächster Schritt:** `projekte/01-basic/` (SQL auf einer echten Datenbank) → `projekte/02-medium/` (Bootstrap & Permutationstest selbst bauen) → `projekte/03-final/` (Regression & Zeitreihen-Prognose auf den Bike-Sharing-Daten).
