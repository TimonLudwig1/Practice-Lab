...
**Modul 06 — Theorie der KI 1** · Format: **Jupyter Notebook** (`suche.ipynb`)
...
jupyter lab   # oder: in VS Code die Datei suche.ipynb öffnen
```

## Aufgabenstellung (Schritt für Schritt)

Öffne **`suche.ipynb`**. Die Infrastruktur (Knoten, `expand`, die zwei
...
Im Ordner **`loesung/`** liegt `suche_loesung.ipynb` — vollständig
