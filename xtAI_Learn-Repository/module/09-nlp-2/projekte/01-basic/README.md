...
erste Code-Zelle lädt den Datensatz automatisch nach `daten/` (siehe unten) und cached
...
[`loesung/sentiment_lstm_loesung.ipynb`](loesung/sentiment_lstm_loesung.ipynb). Erst
