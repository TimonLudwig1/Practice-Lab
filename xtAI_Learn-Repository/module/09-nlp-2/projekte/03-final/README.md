...
vollständige, getestete Musterlösung liegt in [`loesung/`](loesung/) — **erst selbst
bauen.**
...
Großbuchstaben, Zeilenumbrüche, Dialog). Automatischer Download, siehe `daten/`.
...
nach `daten/` geladen (siehe `daten/README.md`) und nicht eingecheckt.

## Musterlösung

[`loesung/gpt.py`](loesung/gpt.py) — ein vollständiges, getestetes ~0,8-Mio.-Parameter-GPT
