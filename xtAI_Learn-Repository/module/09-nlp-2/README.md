...
- **01 – basic** (`projekte/01-basic/`): **Sentiment-Klassifikation mit einem LSTM.**
...
- **02 – medium** (`projekte/02-medium/`): **Self-Attention von Hand + ein
...
- **03 – final** (`projekte/03-final/`): **Ein Zeichen-Level-GPT von Grund auf.** Keine
