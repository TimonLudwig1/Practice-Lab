...
- **01 – basic** (`projekte/01-basic/`): **Faltung & Filter von Hand + gelernte Filter.**
...
- **02 – medium** (`projekte/02-medium/`): **Transfer Learning als Feature-Extraktor.**
...
- **03 – final** (`projekte/03-final/`): **Bildklassifikator für eine neue Domäne — drei
