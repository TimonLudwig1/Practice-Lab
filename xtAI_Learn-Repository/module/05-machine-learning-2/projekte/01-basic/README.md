...
jupyter lab module/05-machine-learning-2/projekte/01-basic/mlp_von_hand.ipynb
```

## Aufgabenstellung (Schritt für Schritt)

Arbeite `mlp_von_hand.ipynb` durch. Die Struktur:
...
In [`loesung/loesung.ipynb`](loesung/loesung.ipynb) — vollständig ausgeführt mit allen Outputs. Erst selbst probieren; der Gradient Check sagt dir zuverlässig, ob dein Backprop stimmt.
