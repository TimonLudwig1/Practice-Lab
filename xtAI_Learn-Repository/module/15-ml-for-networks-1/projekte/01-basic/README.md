...
**Format: Jupyter Notebook** (`flow_klassifikation.ipynb`). **Warum?** Hier geht es um
...
[`loesung/flow_klassifikation_loesung.ipynb`](loesung/flow_klassifikation_loesung.ipynb).
