...
**Format:** Jupyter Notebook (`modellrennen.ipynb`).
...
Vollständig ausgeführte Musterlösung: [`loesung/loesung.ipynb`](loesung/loesung.ipynb). Bitte erst selbst versuchen — das Modul lebt vom Handwerk, nicht vom Abschreiben.
