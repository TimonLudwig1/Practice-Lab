...
```bash
cd module/20-point-cloud-processing/projekte/01-basic
...
Vollständige, ausgeführte Lösung in [`loesung/pointcloud_basics_loesung.ipynb`](loesung/pointcloud_basics_loesung.ipynb) — **erst selbst probieren!**
