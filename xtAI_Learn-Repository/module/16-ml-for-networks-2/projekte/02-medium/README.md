...
trainiert das GCN auf 10 670 Knoten in ~5 s. Der Graph wird beim ersten Lauf nach `daten/`
...
Vollständig in [`loesung/`](loesung/). Erst selbst versuchen — die Tests sagen dir sehr genau,
