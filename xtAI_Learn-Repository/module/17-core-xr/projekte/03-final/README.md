...
Vollständig und getestet in [`loesung/`](loesung/) (Generator, Statistik-Werkzeuge, `run.py`,
...
```bash
/.../xtAI_Learn-Repository/.venv/bin/python loesung/test_study.py   # 17 Tests, ~1 s
/.../xtAI_Learn-Repository/.venv/bin/python loesung/run.py          # Auswertung + Plot, ~1 s
```
