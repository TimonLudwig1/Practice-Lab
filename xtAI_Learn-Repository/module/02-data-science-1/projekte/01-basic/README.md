...
**Format:** Jupyter Notebook (`pandas_grundlagen.ipynb`).
...
Vollständig ausgeführte Musterlösung mit allen Outputs und Plots: [`loesung/loesung.ipynb`](loesung/loesung.ipynb).
