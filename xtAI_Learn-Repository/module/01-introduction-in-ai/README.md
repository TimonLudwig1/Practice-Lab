...
**Nächster Schritt:** Ab in die Projekte → `projekte/01-basic/` (A\*-Wegsuche), dann `projekte/02-medium/` (Tic-Tac-Toe mit Minimax), dann `projekte/03-final/` (Spamfilter mit Naive Bayes auf echten Daten).
