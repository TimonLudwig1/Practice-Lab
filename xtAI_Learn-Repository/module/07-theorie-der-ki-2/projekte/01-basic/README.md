...
**Modul 07 — Theorie der KI 2** · Format: **Jupyter Notebook** (`planung.ipynb`)
...
jupyter lab    # oder planung.ipynb in VS Code öffnen
```

## Aufgabenstellung (Schritt für Schritt)

Öffne **`planung.ipynb`**. Teil A (STRIPS + Blocksworld) und Teil B (Suchknoten,
...
In **`loesung/`** liegt `planung_loesung.ipynb` — vollständig implementiert und
