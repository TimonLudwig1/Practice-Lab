...
- **01 – basic** (`projekte/01-basic/`): **Punktoperationen & Histogrammausgleich von
...
- **02 – medium** (`projekte/02-medium/`): **Frequenzraum & Entrauschen.** Python-Projekt
...
- **03 – final** (`projekte/03-final/`): **Seam Carving (content-aware Resizing).** Keine
