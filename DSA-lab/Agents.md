...
4. `PROGRESS.md` aktualisieren (Tracker-Zelle, neuer NÄCHSTE-AKTION-Block,
   ...
   (z. B. `modul-04: 02-medium fertig`). Jeder von Codex erstellte Commit erhält
   zusätzlich den Co-Author-Trailer aus der Git-Regel unten.
...
### Git-Commits von Codex

Jeder Commit, den Codex im Rahmen dieses Labs erstellt, muss nach einer Leerzeile
exakt diesen Trailer enthalten:

```text
Co-authored-by: Codex <267193182+codex@users.noreply.github.com>
```

Der Trailer darf pro Commit nur einmal vorkommen. Dadurch ordnet GitHub den
Commit zusätzlich dem verifizierten Codex-Konto zu und führt Codex unter den
Contributors auf.
